...
<template>
    <div
        class="group relative flex w-full max-w-[359px] shrink-0 flex-col rounded-3xl border bg-white p-[25px] transition-all duration-300 dark:bg-[#0b161a] sm:p-[33px] lg:w-[354px]"
        :class="featured
            ? 'border-[1.5px] border-[var(--accent)] shadow-[0_0_0_4px_rgba(37,211,102,0.12),0_18px_30px_rgba(37,211,102,0.12)] dark:-translate-y-0 lg:w-[359px] lg:-translate-y-[10px] lg:py-[52px]'
