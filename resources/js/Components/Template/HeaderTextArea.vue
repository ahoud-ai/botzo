        ...
        <div>
            ...
            <div class="flex items-center justify-between mt-2 mb-2">
                ...
                <div class="flex items-center gap-x-3">
                    <button type="button" @click="addVariable" class="hover:bg-black/5 dark:hover:bg-white/10 rounded p-1 text-sm cursor-pointer" :disabled="variableButtonDisabled">{{ $t('Add variable') }} ({{ $t('Max: 1') }})</button>
                </div>
            </div>
        </div>
        <div v-if="placeholders.length > 0" class="ui-bg-soft p-2 rounded-md">
            <div class="mb-4">
                <h2 class="ui-text-muted mb-2">{{ $t('Samples for header content') }}</h2>
