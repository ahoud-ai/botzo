        ...
        <div>
            ...
            <div class="flex items-center justify-between mt-2 mb-2">
                ...
                <div class="flex items-center gap-x-3">
                    <button type="button" @click="format('bold')" class="hover:bg-slate-100 rounded p-1">
                    ...
                    <button type="button" @click="format('italic')" class="hover:bg-slate-100 rounded p-1">
                    ...
                    <button type="button" @click="format('strike-through')" class="hover:bg-slate-100 rounded p-1">
                    ...
                    <button type="button" @click="format('monospace')" class="hover:bg-slate-100 rounded p-1">
