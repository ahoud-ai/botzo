...
<template>
    <section
        ...
        id="pricing"
        v-reveal
        class="px-5 md:px-10 lg:px-20 2xl:px-32 py-12 md:py-16 lg:py-20 bg-[var(--surface-2)] dark:bg-[#0a0f17]"
    >
        <div class="flex flex-col items-center gap-8 lg:gap-[72px]">
            ...
            <!-- Slot for a banner-style block (e.g. Meta verification) that used to be
                 its own near-empty section — kept inside pricing's ground now instead. -->
            <slot name="banner" />
        </div>
    </section>
</template>
