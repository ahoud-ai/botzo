...
<template>
    <div class="relative text-base leading-6">
        ...
        >
            <span class="hidden md:inline whitespace-nowrap">{{ $t(currentLanguageName) }}</span>
        ...
        <div
            v-if="isOpen"
            class="ui-layer-dropdown ui-dropdown-start lang-toggle-menu absolute p-1 w-full min-w-[10em] rounded-lg border shadow-lg"
