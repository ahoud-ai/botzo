...
<template>
    ...
    <div class="flex items-center justify-between mt-2">
        ...
        <div class="flex items-center gap-x-3">
            <button type="button" class="hover:bg-slate-100 rounded p-1" @click="format('bold')">
            ...
            <button type="button" class="hover:bg-slate-100 rounded p-1" @click="format('italic')">
            ...
            <button type="button" class="hover:bg-slate-100 rounded p-1" @click="format('strikethrough')">
            ...
            <button type="button" class="hover:bg-slate-100 rounded p-1" @click="format('monospace')">
    ...
    <div class="mt-3 bg-slate-100 p-3">
        ...
        <div class="mt-4">
            <div v-for="(variable, index) in props.variables" :key="index" class="flex items-center gap-x-2 w-full">
                <span>{{ 1 }}</span>
