...
<template>
    <div class="px-6 md:px-20 overflow-y-auto h-full min-h-0">
        <div class="flex justify-center gap-x-8 items-center pb-6 pe-20 border-gray-300 border-b">
            <div>
                <div class="rounded-full p-1">
                    <img v-if="contact.avatar" class="rounded-full w-40 h-40" :src="contact.avatar" alt="">
            ...
            <div>
                ...
                <div class="flex gap-x-3 mt-4">
                    <button type="submit" v-if="canEdit" class="bg-gray-200 h-9 px-4 rounded-md flex items-center">
                        <Link :href="'/contacts/' + contact.uuid + '?edit=true'" class="text-[14px]">{{ $t('Edit') }}</Link>
                    </button>
                    <button type="submit" class="bg-gray-200 h-9 px-4 rounded-md flex items-center">
                    ...
                    <button type="button" @click="favorite()" class="bg-gray-200 h-9 px-4 rounded-md">
                    ...
                    <Dropdown v-if="canDelete" class="h-100" :align="'right'">
                        <button type="submit" class="h-9 bg-gray-200 py-2 px-3 rounded-md flex items-center">
                            <span class="">
        ...
        <div class="pe-20 border-gray-300 border-b py-4">
            <div class="grid grid-cols-2 gap-x-8 text-[14px]">
                <div class="text-end text-slate-500 pb-2">
        ...
        <div v-if="locationSettings === 'before' && fields.length > 0" class="pe-20 border-gray-300 border-b py-4">
        ...
        <div v-if="locationSettings === 'after' && fields.length > 0" class="pe-20 border-gray-300 border-t py-4">
            <div v-for="(input, index) in props.fields" class="grid grid-cols-2 gap-x-8 text-[14px]">
                <div class="text-end text-slate-500 pb-2">
                    <span>{{ $t(input.name) }}</span>
                </div>
