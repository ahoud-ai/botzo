            ...
            <div class="flex justify-center gap-x-8 items-center pb-6 pe-20 border-gray-300 border-b">
                ...
                <div>
                    ...
                    <div class="flex gap-x-3 mt-4">
                        <button type="button" class="bg-gray-200 py-2 px-4 h-9 rounded-md flex items-center" @click="openModal('edit')">
                            <span class="text-[14px]">{{ $t('Edit') }}</span>
                        </button>
                        <button type="button" @click="deleteRow()" class="bg-gray-200 py-2 px-4 h-9 rounded-md flex items-center">
