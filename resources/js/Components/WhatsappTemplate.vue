...
<template>
    <div v-if="visible" class="me-auto rounded-lg rounded-tl-none my-[0.1em] p-1 text-sm bg-white flex flex-col relative speech-bubble-left max-w-[25em]">
    ...
    <div v-if="parameters?.buttons?.length > 0" class="me-auto text-sm ui-text-primary flex flex-col relative max-w-[25em]">
        <div v-for="(item, index) in parameters.buttons" :key="index" class="flex justify-center items-center gap-x-2 rounded-lg bg-white h-10 my-[0.1em]">
            <span>
