...
<template>
    <div v-if="!canReply" class="flex justify-center items-center w-full px-6 md:px-4">
        <div class="flex items-start gap-x-4 rounded-lg border border-slate-200 bg-slate-50 p-3 text-sm text-slate-600">
    ...
    <div v-if="canReply && props.chatLimitReached" class="flex justify-center items-center w-full px-6 md:px-4">
        <div class="flex items-start gap-x-4 bg-orange-100 rounded-lg p-2 mb-2 px-4">
    ...
    <div v-if="canReply && !replyWindowOpen && !props.chatLimitReached" class="flex justify-center items-center w-full px-6 md:px-4">
        <div class="flex items-center justify-between gap-x-4 bg-orange-100 rounded-lg p-2 mb-2 px-4">
        ...
        <div class="bg-white rounded-md w-full p-4">
            ...
            <div class="flex gap-x-4 items-center text-gray-600">
                <div @click="viewTemplate()" class="flex gap-x-1 text-sm items-center">
                    ...
                    <button type="submit">{{ $t('Templates') }}</button>
                </div>
                <div>|</div>
                ...
                <div v-if="props.showAiAssist" class="ms-[-5px]">
                    <button v-if="!processingAISuggestions" class="text-[14px] flex items-center gap-2 hover:bg-gray-100 p-1 rounded-md disabled:cursor-not-allowed disabled:opacity-60" type="button" :disabled="processingForm" @click="getSuggestion()">
                ...
                <div class="ms-auto">
                    <button type="submit" class="flex items-center gap-x-2 p-1 px-2 rounded-md border border-gray-400 text-sm" :disabled="processingForm || ((formTextInput === null || formTextInput.trim() === '') && !form2.file)">
                        <span :class="(formTextInput === null || formTextInput.trim() === '') && !form2.file ? 'text-slate-300' : 'text-black'">{{ $t('Send') }}</span>
                        <div>
