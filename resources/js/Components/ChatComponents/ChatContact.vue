        ...
        <div class="pb-6 border-b">
            ...
            <div>
                ...
                <div class="flex gap-x-3 mt-4 justify-center">
                    <button v-if="canEdit" type="submit" class="bg-gray-200 px-4 rounded-md flex items-center">
                        <Link :href="'/contacts/' + contact.uuid + '?edit=true'" class="text-sm">{{ $t('Edit') }}</Link>
                    </button>
                    <button type="button" @click="favorite()" class="bg-gray-200 px-4 rounded-md">
                    ...
                    <Dropdown v-if="canDelete" class="h-100" :align="'right'">
                        <button type="submit" class=" bg-gray-200 py-2 px-3 rounded-md flex items-center">
                            <span class="">
        ...
        <div class="border-t py-4 px-4 space-y-1">
            <div class="flex">
                <div class="mb-3">
                    ...
                    <span class="text-xs text-slate-500">{{ $t('Store notes for your team') }}</span>
                </div>
                <div class="ms-auto">
                    <button type="button" @click="isOpenModal = true;" class="bg-slate-50 p-2 rounded-full shadow-md hover:bg-slate-100 hover:shadow-xl">
