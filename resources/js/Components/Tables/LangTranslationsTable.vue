...
<template>
    ...
    <div class="grid grid-cols-2 bg-gray-50 px-2 md:border-b-0 border-slate-300 text-sm rounded-tr-[8px] rounded-tl-[8px]">
    ...
    <div v-for="(item, index) in props.rows" :key="index">
        <div class="grid grid-cols-2 bg-white px-2 hover:bg-slate-50 md:border-b-0 md:border-t border-slate-300 text-sm border-b cursor-pointer">
            <div class="p-2 flex items-center">
                <div class="max-w-[24em] truncate">{{ item.Key }}</div>
            </div>
            <div class="p-2 truncate flex items-center w-full">
                <div class="block text-start truncate" :class="selectedString != item.Key ? 'max-w-[25em]': 'w-full'">
                ...
                <div v-if="selectedString === item.Key" class="ms-auto hover:bg-gray-200 p-2 rounded-full" @click="submitForm()">
                ...
                <div v-else class="ms-auto hover:bg-gray-200 p-2 rounded-full" @click="openTextArea(item.Key, item.Translation)">
