...
<template>
    <div :class="className">
        <div class="flex items-center gap-x-3">
            <img v-if="imageViewUrl" :src="imageViewUrl" @error="onImageError" alt="" class="w-20 h-20 rounded-full dark:bg-gray-500">
            ...
            <label for="file-upload" class="cursor-pointer rounded-md bg-white px-2.5 py-1.5 text-sm text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">{{ props.label ? t(props.label) : '' }}</label>
        </div>
