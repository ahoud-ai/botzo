...
<template>
    <div :class="className">
        ...
        <div class="flex items-center gap-x-3">
            <div v-if="imageViewUrl" class="h-20 w-48 rounded-lg border-2 border-dashed overflow-hidden">
                <img :src="imageViewUrl" alt="" class="object-contain w-full h-full">
            </div>
            <div v-else class="border-2 border-dashed h-20 w-48 flex rounded-lg items-center justify-center">
