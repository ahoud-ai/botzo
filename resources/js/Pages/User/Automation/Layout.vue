        ...
        >
            <div v-if="!studioMode" class="flex justify-between">
                <div>
                    ...
                    <p class="mb-6 flex items-center text-sm leading-6 text-[var(--ui-muted)]">
            ...
            <div class="min-h-0" :class="studioMode ? '' : 'mt-4 flex gap-4'">
                <div v-if="!studioMode" class="hidden md:block md:w-[240px] md:shrink-0">
                    <div class="rounded-2xl border p-2" style="border-color: var(--ui-border); background: var(--ui-surface);">
                        <ul class="space-y-1 text-sm">
                            <li
                                class="truncate rounded-xl px-1 transition"
                                :class="$page.url === '/automation/basic' ? 'automation-tab-item automation-tab-item--active' : 'automation-tab-item'"
                            >
                            ...
                            <li
                                v-if="$page.props.features?.flowBuilderV2"
                                class="truncate rounded-xl px-1 transition"
                                :class="$page.url.startsWith('/automation/flows') ? 'automation-tab-item automation-tab-item--active' : 'automation-tab-item'"
                            >
