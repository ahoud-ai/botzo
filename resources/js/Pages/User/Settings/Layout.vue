            ...
            <div class="flex justify-between">
                <div>
                    ...
                    <p class="mb-6 flex items-center text-sm leading-6">
                        ...
                        <span class="ms-1 mt-1">{{ $t('Update your organization settings') }}</span>
                    </p>
                </div>
            </div>
        
            <div class="mt-4 flex min-h-0 flex-col gap-4 xl:flex-row xl:items-start">
                <div class="ui-card ui-menu w-full bg-white pb-4 xl:sticky xl:top-6 xl:w-72 xl:shrink-0">
                    <ul class="pt-2 space-y-1 text-sm mb-2 px-2">
                        <li class="hover:bg-slate-50 hover:text-black rounded-md px-1 truncate cursor-pointer" :class="$page.url === '/settings' ? 'bg-slate-50 text-black' : ''">
                        ...
                        <li class="hover:bg-slate-50 hover:text-black rounded-md px-1 truncate cursor-pointer" :class="$page.url.startsWith('/settings/whatsapp') ? 'bg-slate-50 text-black' : ''">
                            <Link rel="noopener noreferrer" href="/settings/whatsapp" class="flex items-center p-2 gap-x-3 rounded-md">
                        ...
                        <li class="hover:bg-slate-50 hover:text-black rounded-md px-1 truncate cursor-pointer" :class="$page.url.startsWith('/settings/contacts') ? 'bg-slate-50 text-black' : ''">
                            <Link rel="noopener noreferrer" href="/settings/contacts" class="flex items-center p-2 gap-x-3 rounded-md">
                        ...
                        <li class="hover:bg-slate-50 hover:text-black rounded-md px-1 truncate cursor-pointer" :class="$page.url.startsWith('/settings/tickets') ? 'bg-slate-50 text-black' : ''">
                            <Link rel="noopener noreferrer" href="/settings/tickets" class="flex items-center p-2 gap-x-3 rounded-md">
                        ...
                        <li v-if="isOwner || moduleActive('AI Assistant') || canViewAutomations" class="hover:bg-slate-50 hover:text-black rounded-md px-1 truncate cursor-pointer" :class="$page.url.startsWith('/settings/automation') ? 'bg-slate-50 text-black' : ''">
                            <Link rel="noopener noreferrer" href="/settings/automation" class="flex items-center p-2 gap-x-3 rounded-md">
                        ...
                        <li v-if="canManageTeam" class="hover:bg-slate-50 hover:text-black rounded-md px-1 truncate cursor-pointer" :class="$page.url === teamSettingsHref || $page.url.startsWith('/settings/company-team') || ($page.url.startsWith('/settings/team/') && !$page.url.startsWith('/settings/team/roles')) ? 'bg-slate-50 text-black' : ''">
                            <Link rel="noopener noreferrer" :href="teamSettingsHref" class="flex items-center p-2 gap-x-3 rounded-md">
                                ...
                                <span>{{ $t(isBranchWorkspace ? 'Team' : 'Company team') }}</span>
                            </Link>
                        </li>
                        <li v-if="canManageRoles" class="hover:bg-slate-50 hover:text-black rounded-md px-1 truncate cursor-pointer" :class="$page.url.startsWith('/settings/team/roles') ? 'bg-slate-50 text-black' : ''">
                            <Link rel="noopener noreferrer" href="/settings/team/roles" class="flex items-center p-2 gap-x-3 rounded-md">
