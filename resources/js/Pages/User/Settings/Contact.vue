                    ...
                    <div class="bg-white border border-slate-200 rounded-lg py-2 text-sm mb-4 pb-4 px-4 mb-20">
                        <div class="w-full py-2 mb-2 mt-2">
                            <div class="flex w-full mb-4">
                                ...
                                <div class="ms-auto">
                                    <button type="button" @click="openModal()" class="rounded-md bg-primary px-3 py-2 text-sm text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">{{ $t('Add fields') }}</button>
                                </div>
                            </div>
                            <div class="w-5/5">
                                <!-- Table Component-->
            ...
            <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-4">
                <form @submit.prevent="submitForm()" class="gap-y-4">
                    <div class="grid grid-cols gap-y-4">
                        ...
                        <div v-if="form.component === 'select'" :class="'col-span-6 mt-2'">
                            <div class="flex pb-2">
                                ...
                                <div class="col-1 ms-auto">
                                    <button type="button" class="btn bg-primary text-xs text-white px-2 rounded-md py-1" @click="add">{{ $t('Add option') }}</button>
                                </div>
                            </div>
                        ...
                        <div class="flex gap-x-4 py-3" :class="'col-span-6'">
