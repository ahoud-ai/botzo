<template>
    <AppLayout>
        <div class="ui-page px-6 py-8 bg-white">
            ...
            <Link href="/settings" class="flex justify-between border-b py-3 mb-2">
                ...
                <div>
                    <svg class="block" xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 256 256"><path fill="currentColor" d="m180.24 132.24l-80 80a6 6 0 0 1-8.48-8.48L167.51 128L91.76 52.24a6 6 0 0 1 8.48-8.48l80 80a6 6 0 0 1 0 8.48"/></svg>
                </div>
            </Link>
            ...
            <Link v-if="isOwner || moduleActive('AI Assistant') || canViewAutomations" href="/settings/automation" class="flex justify-between border-b py-3 mb-2">
                <div class="flex items-center gap-3">
            ...
            <Link v-if="canManageTeam" :href="teamSettingsHref" class="flex justify-between border-b py-3 mb-2">
                <div class="flex items-center gap-3">
            ...
            <Link v-if="canManageRoles" href="/settings/team/roles" class="flex justify-between border-b py-3 mb-2">
                <div class="flex items-center gap-3">
...
<script setup>
    ...
    const moduleActive = (moduleName) => {
        const module = props.modules.find((entry) => entry.name === moduleName);
        if (!module) {
            return false;
        }
