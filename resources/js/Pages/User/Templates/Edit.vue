<template>
    <AppLayout>
        <div class="ui-page ui-fade-up ui-page-frame flex flex-col ui-text-main min-h-full">
            <div class="flex justify-between md:px-8 border-b pb-4">
                <div>
                    ...
                    <p class="flex items-center text-sm leading-6 text-gray-600">
                        ...
                        <span class="ms-1 mt-1">{{ $t('Modify whatsapp template') }}</span>
                    </p>
                </div>
                <div class="gap-x-2 flex items-center">
                    ...
                    <button @click="submitForm()" type="button" class="rounded-md px-3 py-2 text-sm text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 capitalize" :class="isFormValid === true ? 'bg-indigo-600 hover:bg-indigo-500 shadow-sm' : 'bg-gray-200'" :disabled="!isFormValid || isLoading">
            ...
            <div class="md:flex md:flex-grow-1">
                <div class="md:w-[50%] py-4 md:p-8 overflow-y-auto min-h-0">
                    <div class="grid gap-x-6 gap-y-4 sm:grid-cols-6 mb-8">
                        <div class="sm:col-span-6">
                            ...
                            <span class="flex items-center gap-x-1 text-[11px] text-red-800 mt-1">
                                <svg class="text-red-800" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3"/></svg>
                ...
                <div class="md:w-[50%] py-20 px-20 overflow-y-auto chat-bg bg-cover bg-no-repeat">
                    <div class="me-auto rounded-lg rounded-tl-none my-1 p-1 text-sm bg-white flex flex-col relative speech-bubble-left w-[25em]">
                        <div v-if="form.header.format != null && form.header.format != 'TEXT' && form.category != 'AUTHENTICATION'" class="mb-4 ui-bg-soft flex justify-center py-8 rounded">
                    ...
                    <div v-if="form.category != 'AUTHENTICATION' && form?.buttons?.length > 0" class="me-auto text-sm ui-text-primary flex flex-col relative max-w-[25em]">
