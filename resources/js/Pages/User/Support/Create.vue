    ...
    <AppLayout>
        <div class="ui-page ui-fade-up ui-page-frame ui-text-main min-h-full">
            <div class="md:flex justify-between hidden">
                <div>
                    ...
                    <p class="mb-6 flex items-center text-sm leading-6 text-gray-600">
                        ...
                        <span class="ms-1 mt-1">{{ $t('Have an issue? Describe it in detail below') }}</span>
                    </p>
                </div>
                <div>
            ...
            <form @submit.prevent="submitForm()" class="bg-white md:border py-5 md:px-5 rounded-[0.5rem]">
                <div class="mt-5 mb-5 grid grid-cols-2 gap-x-4">
                    <div class="">
                ...
                <div class="flex justify-end py-2">
                    <button type="submit" class="self-end flex items-center gap-x-4 rounded-md bg-black px-3 py-2 text-sm text-white shadow-sm hover:bg-slate-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
