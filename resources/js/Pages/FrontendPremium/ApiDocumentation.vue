    ...
    <FrontendLayout :companyConfig="props.companyConfig" :pages="props.pages">
        ...
        <section class="premium-page-section premium-page-hero px-5 md:px-10 lg:px-20 pt-32 pb-10 2xl:px-60">
            ...
            <div class="premium-page-content max-w-4xl mx-auto text-center">
                <div class="inline-flex mb-5 premium-page-badge">{{ $t('API') }}</div>
        ...
        <section class="premium-page-section px-5 md:px-10 lg:px-20 py-20 2xl:px-60">
            <div class="premium-page-content max-w-7xl mx-auto flex gap-8">
                <!-- Side Menu -->
                <aside class="hidden lg:block w-64 flex-shrink-0 sticky top-24 h-fit">
                    <div class="premium-page-panel p-4">
                        ...
                        <nav class="space-y-1">
                            <a 
                                ...
                                class="premium-page-nav-link block px-3 py-2 text-sm text-gray-700 hover:text-primary rounded-lg transition-colors"
                            >
                                {{ $t('Authentication') }}
                            </a>
                            <template v-for="(section, sectionIndex) in props.apirequests" :key="sectionIndex">
                                <a 
                                    ...
                                    class="premium-page-nav-link block px-3 py-2 text-sm text-gray-700 hover:text-primary rounded-lg transition-colors capitalize"
                                >
                                    {{ $t(section.title) }}
                                </a>
                            </template>
                ...
                <div class="space-y-12">
                    <div v-for="(section, sectionIndex) in props.apirequests" :key="sectionIndex" :id="'section-' + sectionIndex" class="border-b border-gray-200 pb-12 last:border-b-0 scroll-mt-24">
                        ...
                        <div v-for="(endpoint, endpointIndex) in section.value" :key="endpointIndex" class="mb-8">
                            <div class="premium-page-panel p-6 premium-page-interactive">
                ...
                <!-- Base URL Info -->
                <div id="base-url" class="mt-12 premium-page-panel p-6 scroll-mt-24">
