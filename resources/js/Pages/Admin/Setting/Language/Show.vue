<template>
    <AppLayout>
        <div class="flex justify-between">
            <div>
                ...
                <p class="mb-6 flex items-center text-sm leading-6 text-gray-600">
                    ...
                    <span class="ms-1 mt-1">{{ $t('Translate your language') }}</span>
                </p>
            </div>
            <div class="flex items-center gap-x-2">
                <button type="button" @click="isOpenModal = true" class="rounded-md bg-indigo-600 px-3 py-2 text-sm text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">{{ $t('Bulk edit translations') }}</button>
        ...
        <!-- Import Modal-->
        <Modal :label="$t('Bulk Edit')" :isOpen="isOpenModal" @close="isOpenModal = false">
            <ol class="list-decimal ms-4 mt-2 space-y-0 text-sm">
                <li class="mb-0">
            ...
            <div class="max-w-md w-full space-y-8">
                <div class="mt-8 space-y-6">
                    ...
                    <ul class="mt-2 rounded-md ui-bg-soft px-6">
