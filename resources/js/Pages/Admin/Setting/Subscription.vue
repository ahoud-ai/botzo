    ...
    <AppLayout>
        <div>
            ...
            <p class="mb-6 flex items-center text-sm leading-6 text-gray-600">
                ...
                <span class="ms-1 mt-1">{{ $t('Configure how your subscriptions are set') }}</span>
            </p>
        </div>
            ...
            <div class="space-y-12">
                <div class="pb-12">
                    ...
                    <div class="grid gap-3 grid-cols-2 pb-6 border-b md:w-2/3">
                        ...
                        <FormInput v-model="form.trial_limits.automated_replies" :name="$t('Canned/Automated replies limit')" :error="form.errors?.['trial_limits.automated_replies']" :type="'number'" :class="'col-span-1'"/>
                        ...
                        <p class="col-span-2 text-xs text-slate-700">{{ $t('Automated replies and canned replies refer to the same feature. This value applies only to trial accounts.') }}</p>
                    </div>
