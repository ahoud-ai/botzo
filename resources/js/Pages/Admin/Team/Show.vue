            ...
            <div class="md:flex justify-between hidden">
                <div>
                    ...
                    <p class="mb-6 flex items-center text-sm leading-6 text-gray-600">
                        ...
                        <span v-if="props.user === null" class="ms-1 mt-1">{{ $t('Create administrative user and assign role') }}</span>
                        <span v-else class="ms-1 mt-1">{{ $t('Update administrative user and assign role') }}</span>
                    </p>
                </div>
                <div>
                    ...
                    <div class="sm:w-[60%] sm:flex gap-x-6">
                        <div class="sm:w-[80%] grid gap-x-6 gap-y-4 sm:grid-cols-6">
                            ...
                            <FormPhoneInput
                                ...
                                :class="'sm:col-span-3'"
                            />
                            <div v-if="isSystemOwner" class="sm:col-span-6 rounded-xl border border-indigo-100 bg-indigo-50 px-4 py-3 text-sm font-medium text-indigo-800">
