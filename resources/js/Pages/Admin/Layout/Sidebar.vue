<template>
   ...
   <!--<aside class="md:flex flex-col h-full w-80 bg-white hidden">
        <div v-if="getValueByKey('logo') === null" class="flex items-center justify-between px-5 pt-5 h-20 mb-4">
            <h1 class="ms-2 text-3xl">{{ getValueByKey('company_name') }}</h1>
        </div>
        ...
        <div class="flex-grow space-y-3 px-2 overflow-y-auto">
            <div class="flex-1">
                <ul class="pt-2 space-y-1 text-sm pb-4">
                    <li class="hover:bg-slate-50 hover:text-black rounded-md px-2" :class="$page.url.startsWith('/admin/dashboard') ? 'bg-slate-50 text-black' : ''">
                        <Link rel="noopener noreferrer" href="/admin/dashboard" class="flex items-center p-2 gap-x-3 rounded-md">
                    ...
                    <li class="hover:bg-slate-50 hover:text-black rounded-md px-2" :class="$page.url.startsWith('/admin/organization') ? 'bg-slate-50 text-black' : ''">
                        <Link rel="noopener noreferrer" href="/admin/organizations" class="flex items-center p-2 gap-x-3 rounded-md">
                    ...
                    <li class="hover:bg-slate-50 hover:text-black rounded-md px-2" :class="$page.url.startsWith('/admin/user') ? 'bg-slate-50 text-black' : ''">
                        <Link rel="noopener noreferrer" href="/admin/users" class="flex items-center p-2 gap-x-3 rounded-md">
                    ...
                    <li class="hover:bg-slate-50 hover:text-black rounded-md px-2" :class="$page.url.startsWith('/admin/payment-logs') ? 'bg-slate-50 text-black' : ''">
                        <Link rel="noopener noreferrer" href="/admin/payment-logs" class="flex items-center p-2 gap-x-3 rounded-md">
                    ...
                    <li class="hover:bg-slate-50 hover:text-black rounded-md px-2" :class="$page.url.startsWith('/admin/support') ? 'bg-slate-50 text-black' : ''">
                        <Link rel="noopener noreferrer" href="/admin/support" class="flex items-center p-2 gap-x-3 rounded-md">
                    ...
                    <li class="hover:bg-slate-50 hover:text-black rounded-md px-2" :class="$page.url.startsWith('/admin/team/users') ? 'bg-slate-50 text-black' : ''">
                        <Link rel="noopener noreferrer" href="/admin/team/users" class="flex items-center p-2 gap-x-3 rounded-md">
                ...
                <ul class="pb-4 space-y-1 text-sm mt-2 pt-2">
                    <li class="hover:bg-slate-50 hover:text-black rounded-md px-2" :class="$page.url.startsWith('/admin/team/roles') ? 'bg-slate-50 text-black' : ''">
                        <Link rel="noopener noreferrer" href="/admin/team/roles" class="flex items-center p-2 gap-x-3 rounded-md">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 20c0-1.742-1.67-3.223-4-3.773M15 20c0-2.21-2.686-4-6-4s-6 1.79-6 4m12-7a4 4 0 0 0 0-8m-6 8a4 4 0 1 1 0-8a4 4 0 0 1 0 8Z"/></svg>
                            <span>{{ $t('Roles') }}</span>
                        </Link>
                    </li>

                    <li class="hover:bg-slate-50 hover:text-black rounded-md px-2" :class="$page.url.startsWith('/admin/plan') ? 'bg-slate-50 text-black' : ''">
                        <Link rel="noopener noreferrer" href="/admin/plans" class="flex items-center p-2 gap-x-3 rounded-md">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 11v4.8c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874c.427.218.987.218 2.105.218h11.606c1.118 0 1.677 0 2.104-.218c.377-.192.683-.498.875-.874c.218-.428.218-.986.218-2.104V11M3 11V9m0 2h18M3 9v-.8c0-1.12 0-1.68.218-2.108c.192-.377.497-.682.874-.874C4.52 5 5.08 5 6.2 5h11.6c1.12 0 1.68 0 2.107.218c.377.192.683.497.875.874c.218.427.218.987.218 2.105V9M3 9h18M7 15h4m10-4V9"/></svg>
                            <span>{{ $t('Subscription plans') }}</span>
                        </Link>
                    </li>
                    <li class="hover:bg-slate-50 hover:text-black rounded-md px-2" :class="$page.url.startsWith('/admin/faq') ? 'bg-slate-50 text-black' : ''">
                        <Link rel="noopener noreferrer" href="/admin/faqs" class="flex items-center p-2 gap-x-3 rounded-md">
                    ...
                    <li class="hover:bg-slate-50 hover:text-black rounded-md px-2" :class="$page.url.startsWith('/admin/testimonial') ? 'bg-slate-50 text-black' : ''">
                        <Link rel="noopener noreferrer" href="/admin/testimonials" class="flex items-center p-2 gap-x-3 rounded-md">
                    ...
                    <li class="hover:bg-slate-50 hover:text-black rounded-md px-2" :class="$page.url.startsWith('/admin/setting') ? 'bg-slate-50 text-black' : ''">
                        <Link rel="noopener noreferrer" href="/admin/settings/general" class="flex items-center p-2 gap-x-3 rounded-md">
        ...
        <div class="flex items-center m-3 p-2 rounded-xl h-14 py-1 md:py-1 mt-2 gap-x-4 justify-between bg-slate-50">
