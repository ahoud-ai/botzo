<template>
    <Head>
        ...
        <meta name="description" content="Sign in to your account to access your dashboard and manage your business communication." />
    </Head>
        ...
        <div class="flex flex-col justify-between min-h-[100svh] mx-4 sm:mx-8 md:mx-10">
            ...
            <div class="flex items-center justify-center mt-0 flex-1">
                <div class="w-full max-w-[480px]">
                    <!-- Welcome text -->
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-2">{{ $t('Welcome back') }}</h1>
...
<div class="flex items-center justify-between text-sm py-2">
                            <div class="flex items-center">
                                <label for="remember" class="relative flex items-center cursor-pointer group">
                                    ...
                                    >
                                    <div :class="[
                                        'relative w-5 h-5 border-2 rounded-md transition-all duration-200 ease-in-out flex items-center justify-center',
                                        form.remember 
                                    ...
                                    <span class="ms-3 text-sm text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-gray-200 transition-colors">
                                        {{ $t('Remember me') }}
                                    </span>
                                </label>
                            </div>
                            ...
                            <Link href="/forgot-password" 
                                class="text-sm font-normal underline text-primary hover:text-secondary transition-colors">
                                {{ $t('Forgot password?') }}
                            </Link>
                        </div>
                    ...
                    <div class="text-center pt-8">
                        <span class="text-sm text-gray-600 dark:text-gray-400">{{ $t('Don\'t have an account?') }}</span>
                        <Link href="/signup" class="text-sm font-normal underline text-primary hover:text-secondary transition-colors ms-1">
                            {{ $t('Create one here') }}
                        </Link>
                    </div>
                </div>
